...
class Deformer:
    ...
    def setVertexTypesAndDeformations(self, handles, handledeformations, fixed):
        self.selected_verts = [];
        self.fixed_verts = [];
        ...
        handles_ids_verts = [(vid, omath.apply_rotation(handledeformations[i], self.verts[vid])) for i, vid in enumerate(handles)];
        fixed_ids_verts =  [(vid, self.verts[vid]) for vid in handles];
    ...
    def arapParameters(self, vertices, faces, edges, handles, fixed, handledeformations):
        self.setMesh(vertices, faces, edges);
        self.setVertexTypesAndDeformations(handles, handledeformations, fixed);
